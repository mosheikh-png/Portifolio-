    ...
    rollupOptions: {
      output: {
        manualChunks(id) {
          ...
          if (id.includes("/node_modules/.pnpm/framer-motion@") || id.includes("/node_modules/.pnpm/motion-dom@") || id.includes("/node_modules/.pnpm/motion-utils@")) return "motion-vendor";
